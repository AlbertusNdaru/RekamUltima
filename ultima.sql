...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 12, 2020 at 06:45 AM
...
INSERT INTO `detail_rm` (`Id_DRM`, `Anamnesa`, `BeratBadan`, `SuhuTubuh`, `Id_Penyakit`, `Id_RekamMedis`, `Id_Tindakan`, `Id_TenagaMedis`) VALUES
(1, '0', 22, 36, 1, 2, 1, 8);
...
(3, 'Blacky', 'Jantan', 'Anjing', 'Gaktau', 2),
(4, 'Blacky3', 'Jantan', 'Kucing', 'gaktau eh ', 2);
...
--
ALTER TABLE `detail_rm`
  MODIFY `Id_DRM` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
