    ...
    <div class="card-body card-block">
        <div class="row" style="margin-top:35px">
            ...
            <div class="col-md-4 col-sm-3 col-xs-6">
                <div class="card">
                    <div class="card-header">
                        <strong class="card-title">Total Tenaga Medis</strong>
                    </div>

                    <div><?= count($jumlahmedis) ?></div>
                </div>
            </div>
            <div class="col-md-4 col-sm-3 col-xs-6">
                <div class="card">
                    <div class="card-header">
                        <strong class="card-title">Total Pemilik</strong>
                    </div>

                    <div><?= count($jumlahpemilik) ?></div>
                </div>
            </div>
            <div class="col-md-4 col-sm-3 col-xs-6">
                <div class="card">
                    <div class="card-header">
                        <strong class="card-title">Total Hewan</strong>
                    </div>

                    <div><?= count($jumlahhewan) ?></div>
                </div>
            </div>
