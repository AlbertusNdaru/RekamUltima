<div class="breadcrumbs">
    <div class="card">
        ...
        <div class="card-body">
            <form name="formaddpenyakit" id="formvaliditas" action="<?= base_url('Controller_Penyakit/ControllerPenyakit/addpenyakit') ?>" method="POST">
                <div class="row form-group">
                    <div class="col col-md-3"><label>Nama Penyakit</label></div>
                    <div class="col-12 col-md-9"><input required type="text" onclick='validasi("PENYAKIT","PENYAKIT")' name="penyakit" id="PENYAKIT" class="form-control required">
                    </div>
                </div>
                <label class="row form-group">
                    <label class="col col-md-3"><label>Gejala</label></label>
                    <div class="col-12 col-md-9"><textarea required type="text" onclick='validasi("GEJALA","GEJALA")' name="gejala" id="GEJALA" rows="3" class="form-control"></textarea></div>
                </label>
        </div>
