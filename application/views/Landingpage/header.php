            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <a class="navbar-brand" href="index.html"> <img src="<?= base_url('assets/landingpage/'); ?>img/logo.png" alt="logo"> </a>
                        ...
                        <?php if (isset($_SESSION["pemilik"])) { ?>
                            <a class="btn_2 d-none d-lg-block" href="#" style="margin-right: 10px">HOT LINE- 09856</a>
