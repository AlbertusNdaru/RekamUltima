                ...
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <a class="navbar-brand" href="<?= base_url('landing') ?>"> <img
                                src="<?= base_url('assets/landingpage/'); ?>img/logo.png" alt="logo"> </a>
                        ...
                        <div class="collapse navbar-collapse main-menu-item justify-content-center"
                            ...
                            <ul class="navbar-nav align-items-center">
                                ...
                                <li class="nav-item active">
                                    <a class="dropdown-item" href="<?= base_url('registerhewan') ?>">Registrasi
                                        Hewan</a>
                                </li>
                                <li class="nav-item active">
                                    <a class="dropdown-item"
                                        href="<?= base_url('datahewan/' . $_SESSION['pemilik']->Id_Pemilik) ?>">Rekam
                                        Medis & Data Hewan</a>
                                </li>
                                <li class="nav-item active">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        ...
                                        <a class="dropdown-item" href="<?= base_url('editpassword') ?>">Ubah
                                            Password</a>
                                    </div>
                                </li>
                                <!-- <a class="nav-item">
                        ...
                        <?php if (isset($_SESSION["pemilik"])) { ?>
                        <a class="btn_2 d-none d-lg-block" href="#"
                            style="margin-right: 10px"><?= $_SESSION['pemilik']->Nama_Pemilik ?></a>
                        <a class="btn_2 d-none d-lg-block" href="<?= base_url('logoutuser') ?>">LOGOUT</a>
                        <?php } else { ?>
                        <a class="btn_2 d-none d-lg-block" style="margin-right: 10px"
                            href="<?= base_url("loginuser") ?>">LOGIN</a>
